...
TOKEN = '726282634:AAEbbZjFOHxXkFeNvj9RseMoVh84IQ2rLJo'
...
def send_welcome(message):
    ...
    user_markup.row('Оставить заявку на поставку рыбной продукции')
...
def send_welcome(message):
    if message.text == 'Наши контакты':
        bot.send_message(message.from_user.id, 'Наши конатакты'
                                               '\nНомер телефона : +998 903211309'
                                               '\nНаш канал : @diafish')
    elif message.text == 'Оставить заявку на поставку рыбной продукции':
        ...
        bot.send_message(message.from_user.id, 'Для того чтобы оставить заявку на поставку рыбной продукции ,'
        ...
        bot.send_message(message.from_user.id, 'DiaFish:'
                                               '\nЯ вас не понимаю .')
